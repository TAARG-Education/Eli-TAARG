function [r_adim,a_chi,a_first_chi,dCp_corr,w_0,k,Cp_corr] = Opti_prop_P_Newton(N_blade,R_hub,n_rpm,V_inf,Cp,h)
%% \Opti_Prop_TEST.m
%  \brief: Test function
...
% 
% if abs(gradient(dCp-dCp_corr)) == 0 
%      break
% end

w_1 = w_0 -0.1*((dCp-dCp_corr)/gradient(dCp-dCp_corr));
w_0 = w_1;
k   = k+1;

if abs(Cp-Cp_corr) < 0.0001 
     break
end
end
