function [r_adim,a_chi,a_first_chi,dCt_corr,w_0,k,Ct_corr] = Opti_prop_T_corr(N_blade,R_hub,n_rpm,V_inf,Ct,h)
%% \Opti_Prop.m
...
if abs(gradient(dCt-dCt_corr)) == 0 
     break
end

w_1 = w_0 - 0.1*((dCt-dCt_corr)/gradient(dCt-dCt_corr));
w_0 = w_1;
k   = k+1;

if abs(Ct-Ct_corr)/Ct < 0.001 
     break
end
