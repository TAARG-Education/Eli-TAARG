function [r_adim,theta,chord,dT_corr,w_0] = Opti_prop_T(R_tip,N_blade,R_hub,n_rpm,V_inf,T,h)
%% \Opti_Prop.m
...
fprintf(fid, '%s\t%s\t%s\t%s\n', '   r_adim','theta(rad)','chord(r_adim)','dT_corr(r_adim)');  % header
fclose(fid);
