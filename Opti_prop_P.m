...
function [r_adim,a_chi,a_first_chi,dCp_new,w_0,k,Cp_new,dCt] = Opti_prop_P(N_blade,R_hub,n_rpm,V_inf,Cp,h)
...
dCt = dP/((V_inf+w)*(rho*(n_rps^2)*(2^4)));
...
title('Power coefficient distribution $\frac{dC_{T}}{d\bar{r}}$ vs $\bar{r}$','interpreter','latex');
